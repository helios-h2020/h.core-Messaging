...
class Tracker extends events_1.EventEmitter {
    constructor(opts) {
        ...
        this.trackerServer.on(TrackerServer_1.Event.NODE_STATUS_RECEIVED, (statusMessage, nodeId) => {
            ...
            if (valid) {
                ...
                this.trackerServer.disconnectFromPeer(nodeId, AbstractWsEndpoint_1.DisconnectionCode.INVALID_PROTOCOL_MESSAGE, AbstractWsEndpoint_1.DisconnectionReason.INVALID_PROTOCOL_MESSAGE);
            }
        });
    ...
    updateNodeOnStream(node, status) {
        ...
        if (status.counter === InstructionCounter_1.COUNTER_UNSUBSCRIBE) {
