...
exports.DOCKER_DEV_STORAGE_NODE = void 0;
...
const sideChainConfig = {
    ...
    rpcs: [{
            ...
            timeout: (_a = toNumber(process.env.TEST_TIMEOUT)) !== null && _a !== void 0 ? _a : 30 * 1000,
        }]
};
/**
...
exports.default = {
    ...
    mainChainRPCs: {
        ...
        rpcs: [{
                ...
                timeout: (_b = toNumber(process.env.TEST_TIMEOUT)) !== null && _b !== void 0 ? _b : 30 * 1000
            }]
    },
...
exports.DOCKER_DEV_STORAGE_NODE = '0xde1112f631486CfC759A50196853011528bC5FA0';
