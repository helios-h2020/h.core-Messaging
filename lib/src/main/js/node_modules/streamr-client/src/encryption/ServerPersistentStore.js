...
class ServerPersistentStore {
    constructor({ context, clientId, streamId, initialData = {}, rootPath = './', migrationsPath = (0, path_1.join)(__dirname, 'migrations') }) {
        ...
        const dbFilePath = (0, path_1.resolve)(paths.data, (0, path_1.join)(rootPath, clientId, 'GroupKeys.db'));
        this.dbFilePath = dbFilePath;
        this.migrationsPath = migrationsPath;
        this.init = (0, utils_1.pOnce)(this.init.bind(this));
    }
    async exists() {
        if (this.initCalled) {
    ...
    async destroy() {
        ...
        await this.clear();
        await this.close();
        this.init = (0, utils_1.pOnce)(Object.getPrototypeOf(this).init.bind(this));
    }
