...
export default class StreamMessageValidator {
    ...
    static checkInjectedFunctions(getStream: (streamId: StreamID) => Promise<StreamMetadata>, isPublisher: (address: string, streamId: StreamID) => Promise<boolean>, isSubscriber: (address: string, streamId: StreamID) => Promise<boolean>, verify: (address: string, payload: string, signature: string) => Promise<boolean>): void | never;
    /**
