...
/**
 * Parse public key test string and compare key components to stored values.
 */
class RsaPublicKeyReaderTest {
    ...
    @Test
    fun testModulus() {
        val keyReader = RsaPublicKeyReader(publicKey)
    ...
    private val publicKey: String = "CAASpgIwggEiMA0GCSqGSIb3DQEBAQUAA4IBDwAwggEKAoIBAQCRyxN+ZCs" +
            "oKqJfMxhtKJ7qy9214hoshuLnB+tnOu6AaRHcDhbrFRKzEc+nlatMYWz9S5AEnJWlKQbkGy3/nGoDYNFc8i" +
            "1Qr0h3lgw0RD6EzL+1SeD6Ch3ujLO9Opv3z4MfUp5mCbEwK7hpinxdY6qIApM/VH9+KCNfhmJseYnR8GStw" +
            "CSQW1yS9FffbyvVfKRrutfz9pr7TcQrOwkSXso4CowcMeL94Xi42qGI9d4WgOQPRgIluCQNTpZLF/wKGytG" +
            "4Heu0lPImYKlif8U5u+Ee2+dVUzN5nneiW238AkWAKK4sS8jBRODq9KEn1BzaBBT2N/8L7o84Ve5xmsx8TX" +
            "9AgMBAAE="
